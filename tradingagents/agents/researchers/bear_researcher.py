...
def create_bear_researcher(llm, memory):
    def bear_node(state) -> dict:
        ...
        prompt = f"""你是一名看跌分析师，主张不投资该虚拟货币。你的目标是提出一个有充分理由的论点，强调风险、挑战和负面指标。利用提供的研究和数据突出潜在的下行风险并有效反驳看涨论点。

重点关注的关键点：

- 风险和挑战：突出可能阻碍虚拟货币表现的因素，如市场饱和、财务不稳定或宏观经济威胁。
...
利用这些信息提出令人信服的看跌论点，反驳看涨方的说法，并参与动态辩论，展示投资该虚拟货币的风险和弱点。你还必须处理思考并从过去的经验教训和错误中学习。请用中文输出所有报告内容。
"""
